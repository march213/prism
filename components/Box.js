...
let images = {
  back: 'https://gateway.ipfs.io/ipfs/QmcikiCcADivoacpS7S7XjQQ6GdHeAuCpGJu4DViDFbKDt',
  ...
  front: 'https://gateway.ipfs.io/ipfs/QmYtTbQ24zGwhLKZ5VtZyimYg6ZoY7gKqu72rvY5rtHe62',
  ribbon: 'https://gateway.ipfs.io/ipfs/QmPZ8FsQr4W7oHedSnhtyKJuz7w8jXPmEKXqxnG7sQGUee',
...
const Box = function () {
  ...
  useEffect(() => {
    ...
    if (boxTag.current) {
      ...
      const textures = [images.edge, images.edge, images.edge, images.edge, images.back, images.front].map((url) =>
        loader.load(url),
      );
